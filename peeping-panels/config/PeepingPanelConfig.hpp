...
// 			add("far4"     , far4     );
		...
		std::array<int,4> visible1, close1, near1, far1;
		std::array<int,4> visible2, close2, near2, far2;
		std::array<int,4> visible3, close3, near3, far3;
		std::array<int,4> visible4, close4, near4, far4;
};
